...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'title', 'slug', 'slug_ci', 'short_description', 'full_description', 'price', 'currency', 'author_id', 'main_category_id', 'isbn', 'language', 'pages', 'publisher', 'published_at', 'sku', 'is_active', 'is_available', 'stock_quantity', 'created_at', 'updated_at', 'version', 'deleted_at', 'is_live' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'slug_ci', 'is_live' ], [ 'tenant_id', 'isbn' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'author_id', 'main_category_id', 'pages', 'stock_quantity', 'version', 'is_live' ]; }
