 ...
 * - whitelist filtrů: [ 'id', 'title', 'slug', 'short_description', 'full_description', 'price', 'currency', 'author_id', 'main_category_id', 'isbn', 'language', 'pages', 'publisher', 'published_at', 'sku', 'is_active', 'is_available', 'stock_quantity', 'created_at', 'updated_at', 'version', 'deleted_at' ]
 * - whitelist LIKE:   [ 'title', 'slug', 'short_description', 'full_description', 'currency', 'isbn', 'language', 'publisher', 'sku' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'title', 'slug', 'short_description', 'full_description', 'price', 'currency', 'author_id', 'main_category_id', 'isbn', 'language', 'pages', 'publisher', 'published_at', 'sku', 'is_active', 'is_available', 'stock_quantity', 'created_at', 'updated_at', 'version', 'deleted_at' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'title', 'slug', 'short_description', 'full_description', 'currency', 'isbn', 'language', 'publisher', 'sku' ];
            $likeParts = []; $i=0;
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'title', 'slug', 'short_description', 'full_description', 'price', 'currency', 'author_id', 'main_category_id', 'isbn', 'language', 'pages', 'publisher', 'published_at', 'sku', 'is_active', 'is_available', 'stock_quantity', 'created_at', 'updated_at', 'version', 'deleted_at' ], true);
            $parts = [];
