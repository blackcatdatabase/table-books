...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'tenant_id', 'title', 'slug', 'slug_ci', 'short_description', 'full_description', 'price', 'currency', 'author_id', 'main_category_id', 'isbn', 'language', 'pages', 'publisher', 'published_at', 'sku', 'is_active', 'is_available', 'stock_quantity', 'created_at', 'updated_at', 'version', 'deleted_at', 'is_live' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'tenants' => 'j0', 'authors' => 'j1', 'categories' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Books\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Books\Definitions::softDeleteColumn();
