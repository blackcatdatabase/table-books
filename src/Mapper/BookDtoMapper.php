...
namespace BlackCat\Database\Packages\Books\Mapper;
...
final class BookDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'short_description' => 'shortDescription', 'full_description' => 'fullDescription', 'author_id' => 'authorId', 'main_category_id' => 'mainCategoryId', 'published_at' => 'publishedAt', 'is_active' => 'isActive', 'is_available' => 'isAvailable', 'stock_quantity' => 'stockQuantity', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt', 'deleted_at' => 'deletedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [ 'is_active', 'is_available' ];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'author_id', 'main_category_id', 'pages', 'stock_quantity' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'price' ];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'published_at', 'created_at', 'updated_at', 'deleted_at' ];
    /** @var string[] */
    private const BIN_COLS    = [];
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'short_description', 'full_description', 'isbn', 'language', 'pages', 'publisher', 'published_at', 'sku', 'deleted_at' ];
     ...
     */
    public static function fromRow(array $row): BookDto {
        $vals = [];
     ...
     */
    public static function toRow(BookDto $dto, ?array $onlyProps = null): array {
        $out = [];
