...
> Lineage: 3 outbound / 7 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (0 d)
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package books -Apply
